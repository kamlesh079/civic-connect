    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">
          Provide details about the problem to help authorities resolve it faster.
        </p>
      </div>
        ...
        <div className="p-6 space-y-6">
            ...
            <div>
              ...
              {formData
                ...
                <p className="text-xs text-red-500 flex items-center mt-2">
                  ...
                  GPS coordinates are required to dispatch officers accurately.
                </p>
              )}
            </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500">
              Upload up to 5 JPG, PNG, or WebP images. Each image must be 5 MB or smaller.
            </p>
